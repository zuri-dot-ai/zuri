...
export const FREE_LIMITS = {
  websitePreviewOnly: true,    // can preview, cannot publish
  contentVisibleDays: 3,       // calendar blurred after day 3
  planVisibleDays: 7,          // action plan preview = first 7 days
} as const;
...
export const BADGES: Record<string, Badge> = {
  first_post: {
    id: "first_post", label: "First Post", emoji: "🏅",
    description: "Completed your very first task.",
  },
  streak_7: {
    id: "streak_7", label: "7-Day Streak", emoji: "🔥",
    description: "Seven days in a row. You're building momentum.",
  },
  streak_30: {
    id: "streak_30", label: "30 Days Strong", emoji: "💪",
    description: "A full month of consistency.",
  },
  content_30: {
    id: "content_30", label: "Content Machine", emoji: "✨",
    description: "Completed 30 content tasks.",
  },
  graduate_90: {
    id: "graduate_90", label: "90-Day Graduate", emoji: "🏆",
    description: "You finished the full 90-day journey.",
  },
};

// ── WEBSITE TYPES (onboarding selector) ─────────────────
