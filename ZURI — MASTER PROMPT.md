...
**Brand**: Dark mode only and Light mode. Background `#0C0C0E`. Gold accent `#C9A84C`. Typography: Cormorant Garamond (headings) + Montserrat (body). Lucide React icons only — no emojis anywhere in the app UI.
...
```
launchzuri.com                     → Main app + marketing (single Next.js deployment)
...
2. Show the live website at [handle].zurisite.com
